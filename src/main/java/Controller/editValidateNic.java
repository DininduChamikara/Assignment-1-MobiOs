...
@WebServlet(name = "editValidateNic", urlPatterns = {"/editValidateNic"})
public class editValidateNic extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Upto this point correct");
            
            RequestDispatcher rd = request.getRequestDispatcher("editUser.jsp?id=" + id);
